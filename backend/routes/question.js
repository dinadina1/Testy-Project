...
const {newQuestion, newQuestions, getQuestion, getAllQuestions, deleteQuestion, getParticularQuestion, updateQuestion, downloadTemplate} = require('../controllers/questionController');
...
// admin routes
router.route('/admin/template').get(isAuthenticatedUser, authorizeRoles('admin'), downloadTemplate);
